...
namespace labutils
{
	...
	void buffer_barrier(VkCommandBuffer aCmdBuffer, VkBuffer aBuffer, VkAccessFlags aSrcAccessMask, VkAccessFlags aDstAccessMask, VkPipelineStageFlags aSrcStageMask, VkPipelineStageFlags aDstStageMask, VkDeviceSize aSize, VkDeviceSize aOffset, uint32_t aSrcQueueFamilyIndex, uint32_t aDstQueueFamilyIndex)
	{
	...
	Sampler create_default_sampler(VulkanContext const& aContext)
	{
		...
		//Query whether vulkan supports anisotropic filtering
